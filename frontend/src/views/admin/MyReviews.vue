  ...
  <div class="my-reviews-page">
    ...
    <el-dialog v-model="scoreDialogVisible" title="提交评审打分" width="520px" @close="resetScoreForm">
      <div class="score-dialog-info" v-if="currentTask">
        <el-descriptions :column="1" border size="small">
          ...
          <el-descriptions-item label="参赛对象">{{ getParticipantDisplayName(currentTask) }}</el-descriptions-item>
        </el-descriptions>
    ...
    <el-dialog v-model="viewDialogVisible" title="评审详情" width="500px">
      <el-descriptions :column="1" border v-if="viewTask">
        ...
        <el-descriptions-item label="参赛对象">{{ getParticipantDisplayName(viewTask) }}</el-descriptions-item>
...
const downloadFile = async (row) => {
  ...
  try {
    await downloadWorkFile(row.workFileUrl, row.workFileName || row.workTitle || '作品文件')
  } catch (error) {
